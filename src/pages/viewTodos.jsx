...
const data = useSelector(state => state.loginReducer.userDetails)
    ...
    ;(
      async()=>{
        if (data) {
          ...
          resp.data.message? alert(resp.data.message) :  setTodosList([...todosList,...resp.data]) 
        }
      }
    )()
  },[])
  ...
  return <DisplayTodos todos={todosList} editTodos={editTodoMember} deleteTodo={deleteTodo} completedTodos={completedTodos} />
};
